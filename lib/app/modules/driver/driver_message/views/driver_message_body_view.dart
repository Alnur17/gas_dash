...
class DriverMessageBodyView extends GetView {
  const DriverMessageBodyView({super.key});
  @override
  Widget build(BuildContext context) {
    final messageController = Get.put(DriverMessageController());
    return Scaffold(
  ...
  Widget _buildMessageInput() {
    ...
    final DriverMessageController messageController = Get.find();
